...
# Plot the image and the clusters - image function in r, which takes a matrix as its input
# we concanate/c() fn to change the matrix to a vector
#dim fn sets the dimesion of the var
...
# Run k-means #iter is cus kmeans is a iterative process, can take a log time, repeateded.
set.seed(1)
...
# scree plots - find elbow, no of k clusters where within clster variace s not really further improved
